...
export default function Home() {
  return (
    <div className="relative min-h-screen m-2.5 sm:m-5 font-sans max-lg:flex max-lg:flex-col max-lg:bg-red-400 max-lg:rounded-[40px] max-lg:justify-center max-lg:items-center ">
      <div className=" rededge-1"></div>
       <div className=" coverdot-1"></div>
       
       <div className=" rcorners  "></div>
       <div className=" coverdot"></div>
       <div className=" rededge"></div>
        
        <div className=" coverdot-2"></div>
        <div className=" rededge-2"></div>

       <div className=" rcorners-2  "></div>
       <div className=" rcorners-3  "></div>
      <div className="lg:absolute flex justify-center max-lg:my-auto items-center gap-14 h-full w-full bg-color1 rounded-[75px]">
